...
[session\_start\_score.php](../oefenen/onderwerp-6/session_start_score.php) om de naam te onthouden,   
[session\_score\_opvragen.php](../oefenen/onderwerp-6/session_score_opvragen.php) om de score te laten zien die hoort bij de naam die onthouden is via de cookie, en   
[session\_verwijderen.php](../oefenen/onderwerp-6/session_verwijderen.php) om de sessie te verwijderen, inclusief de cookie.  
...
Zet deze regel maar bovenaan in [session\_start\_score.php](../oefenen/onderwerp-6/session_start_score.php), op regel 5. Voer alle andere stappen hieronder ook uit, zodat je ziet hoe het werkt.
...
Het bestand [session\_start\_score.php](../oefenen/onderwerp-6/session_start_score.php) heeft dezelfde opbouw die je eerder ook al zag. Als er iets opgestuurd wordt met het formulier, dan moet daar iets mee gedaan worden. In dit geval gaan we ook gegevens in de sessie opslaan.
...
Nu wordt de naam opgeslagen in de sessie als die ingevoerd wordt door de gebruiker. Het bestand ziet er als het goed is nu zo uit: [uitwerking\_session\_start\_score.php](../oefenen/onderwerp-6/uitwerking_session_start_score.php).



---

[← 5.2: Gegevens verbergen](5-2-gegevens-verbergen.md) | [6.2: Sessie lezen →](6-2-sessie-lezen.md)
